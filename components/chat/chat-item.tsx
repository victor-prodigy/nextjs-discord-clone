...
export const ChatItem = ({
    ...
    // quando clicar em uma foto de perfil de um usuario no chat
    const onMemberClick = () => {
    ...
    useEffect(() => {
        ...
        return () => window.removeEventListener("keyDownw", handleKeyDown);
    }, []);
    ...
    const canDeleteMessage = !deleted && (isAdmin || isModerator || isOwner); // isOwner => Dono/Proprietário
        ...
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {/* se o arquivo de upload for imagem ".png" etc */}
                    {isImage && (
                        <a
                            href={fileUrl}
                            target="_blank"
                    ...
                    {/* se o arquivo de upload for imagem ".pdf" */}
                    {isPDF && (
                    ...
                    {/* formulario com input para editar mensagem */}
                    {!fileUrl && isEditing && (
                        <Form {...form}>
